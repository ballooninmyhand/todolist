...
Component({
    ...
    methods: {
        ...
        submitSelectDate: function () {
            ...
            let month = ''
            let day = ''
            year = this.data.glYears[this.data.glDateMutiIndex[0]]
            month = this.data.glMonths[this.data.glDateMutiIndex[1]]
            day = this.data.glDays[this.data.glDateMutiIndex[2]]
            dateDesc = year + '年' + month + '月' + day + '日'
